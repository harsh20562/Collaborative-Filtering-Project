...
def cli_main(args):
    ...
    train_loss_arr=[];val_loss_arr=[];val_recall_50=[]
    for epoch in range(args.epochs):
        ...
        val_recall_50.append(np.mean(r50_list));
    ...
    plt.grid(True);
    plt.show();
    plt.plot(epochs_arr, val_recall_50, marker='o');
    plt.xlabel('Number of epochs')
    plt.ylabel('Mean Recall@50 loss')
    plt.title('Validation Set Recall@50 vs Epochs')
    plt.grid(True);
    plt.show();
